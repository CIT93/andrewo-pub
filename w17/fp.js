class FP {
  constructor(first, last, houseMembers, houseSize, foodChoice, foodSource, waterConsum, washingMachine, purchases, waste, recycle, vehicleTotal, publicTotal, flightsTotal) {
      this.first = first;
      this.last = last;
      ...
      this.washingMachinePoints = washingMachine;
      this.purchasesPoints = purchases;
      this.wastePoints = waste;
      this.recycle = recycle;
      this.vehiclePoints = vehicleTotal;
      this.publicPoints = publicTotal;
      this.flightsPoints = flightsTotal;
